...
class _RecordingScreenState extends State<RecordingScreen> with TickerProviderStateMixin {
  ...
  void initState() {
    ...
    context.read<TripProvider>().addListener(_onProviderUpdate);
  }

  void _onProviderUpdate() {
    final provider = context.read<TripProvider>();
    final pos = provider.activeTrip != null ? _currentPosition : null;
    if (pos != null) setState(() {});
  }
  ...
  void dispose() {
    ...
    _timer?.cancel();
    context.read<TripProvider>().removeListener(_onProviderUpdate);
    super.dispose();
  }
        ...
        children: [
          Expanded(
            child: FlutterMap(
              ...
              options: MapOptions(
                initialCenter: _points.isNotEmpty ? _points.last : const LatLng(24.0, 45.0),
                initialZoom: 16,
                onMapEvent: (e) {
              ...
              children: [
                ...
                if (_points.isNotEmpty)
                  PolylineLayer(polylines: [
                    Polyline(points: _points, color: const Color(0xFFD4870A), strokeWidth: 4)
                  ]),
                if (_points.isNotEmpty)
                  MarkerLayer(markers: [
                    Marker(
                      point: _points.first,
                      child: const Icon(Icons.flag, color: Color(0xFF4CAF50), size: 28),
                    ),
                    Marker(
                      point: _points.last,
                      child: ScaleTransition(
                        ...
                        child: Container(
                          ...
                          decoration: BoxDecoration(
                            ...
                            boxShadow: [
                              BoxShadow(
                                color: const Color(0xFFD4870A).withOpacity(0.5),
            ...
            child: Row(
              ...
              children: [
                _stat(Icons.straighten, 'DISTANCE',
                    GeoUtils.formatDistance(provider.activeTrip?.totalDistanceMeters ?? 0)),
                _stat(Icons.speed, 'SPEED',
                    pos != null ? GeoUtils.formatSpeed(pos.speed) : '0 km/h'),
                _stat(Icons.timer, 'TIME', GeoUtils.formatDuration(_elapsed)),
              ...
              child: Row(
                ...
                children: [
                  Transform.rotate(
                    ...
                    child: const Icon(Icons.navigation, color: Color(0xFFD4870A), size: 24),
                  ),
                  ...
                  Text('${pos.heading.toStringAsFixed(0)}°',
                      style: const TextStyle(color: Color(0xFFD4870A), fontSize: 14)),
                ],
              ),
            ),
        ],
